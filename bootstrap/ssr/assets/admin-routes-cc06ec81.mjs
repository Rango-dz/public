...
const IconList = React.lazy(() => import("./icon-list-4f0609c1.mjs"));
...
const ArticleBodyEditor$3 = React.lazy(
  () => import("./article-body-editor-5a46980e.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-eaf272ed.mjs"));
...
//# sourceMappingURL=admin-routes-cc06ec81.mjs.map
