...
import { u as useSettings, C as CustomMenu, T as Trans, a as useMediaQuery, g as getFromLocalStorage, s as setInLocalStorage, U as Underlay, c as createSvgIcon, N as Navbar, I as IconButton, m as message, b as useIsMobileMediaQuery, d as useNumberFormatter, S as SelectForwardRef, e as Item, f as useTrans, h as TextField, i as SearchIcon, o as opacityAnimation, P as ProgressBar, j as StaticPageTitle, q as queryClient, t as toast, k as showHttpErrorToast, l as apiClient, D as DialogTrigger, B as Button, n as useDialogContext, p as ConfirmationDialog, r as IllustratedMessage, v as SvgImage, w as Dialog, x as DialogHeader, y as DialogBody, z as DialogFooter, A as onFormQueryError, E as useDateFormatter, F as Form$1, G as FormTextField, H as CheckIcon, J as CloseIcon, K as Chip, L as FormattedDate, M as Tooltip, O as LoginIcon, Q as ButtonBase, R as getInputFieldClassNames, V as FormImageSelector, W as useValueLists, X as DoneAllIcon, Y as List, Z as ListItem, _ as Skeleton, $ as createSvgIconFromTree, a0 as FormSelect, a1 as Section, a2 as MixedText, a3 as FileUploadProvider, a4 as useAppearanceEditorMode, a5 as ProgressCircle, a6 as useNavigate$1, a7 as useBootstrapData, a8 as FullPageLoader, a9 as LinkStyle, aa as SiteConfigContext, ab as getBootstrapData, ac as ExternalLink, ad as MenuTrigger, ae as Menu, af as Checkbox, ag as FormRadioGroup, ah as FormRadio, ai as DateFormatPresets, aj as prettyBytes, ak as useSocialLogin, al as useField, am as Field, an as useResendVerificationEmail, ao as useUser, ap as useUploadAvatar, aq as useRemoveAvatar, ar as slugifyString, as as isAbsoluteUrl, at as useProducts, au as FormattedPrice, av as PageStatus, aw as FormattedRelativeTime, ax as useActiveUpload, ay as useAutoFocus, az as validateUpload, aA as UploadedFile, aB as Disk, aC as SettingsIcon, aD as RadioGroup, aE as Radio, aF as openDialog, aG as PageErrorMessage, aH as ComboBoxForwardRef, aI as openUploadWindow, aJ as UploadInputType, aK as PageMetaTags, aL as WarningIcon, aM as KeyboardArrowDownIcon, aN as shallowEqual, aO as useSelectedLocale, aP as useThemeSelector, aQ as lazyLoader, aR as AuthRoute, aS as useCustomPage, aT as useCollator, aU as loadFonts, aV as NotFoundPage } from "../server-entry.mjs";
...
import { E as EditIcon, B as Breadcrumb, a as BreadcrumbItem, C as ChevronRightIcon, O as OpenInNewIcon } from "./OpenInNew-c12c70b5.mjs";
...
const IconList = React.lazy(() => import("./icon-list-51092b06.mjs"));
...
const AceEditor = React.lazy(() => import("./ace-editor-2bad51ba.mjs"));
function AceDialog({
  defaultValue,
  mode = "html",
  title,
...
function AutoUpdateField() {
  ...
  return /* @__PURE__ */ jsx(ContentAutoUpdateField, { config: channelContentConfig, children: !(methodConfig == null ? void 0 : methodConfig.provider) && tmdb_is_setup && /* @__PURE__ */ jsxs(
    FormSelect,
    {
      selectionMode: "single",
...
const ArticleBodyEditor$3 = React.lazy(
  () => import("./article-body-editor-7c7994cb.mjs")
);
...
const ReportsPage = React.lazy(() => import("./admin-report-page-93d77d94.mjs"));
...
//# sourceMappingURL=admin-routes-8d317180.mjs.map
