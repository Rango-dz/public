...
import { m as message, ah as MenuTrigger, I as IconButton, B as Button, T as Trans, ai as Menu, h as Item, b2 as useCookie, ae as SiteConfigContext, c as createSvgIcon, i as useTrans, t as toast, b3 as FacebookIcon, b4 as TwitterIcon, aF as FormattedRelativeTime, b5 as LockIcon, o as opacityAnimation, R as FormattedDate, K as KeyboardArrowLeftIcon, ad as LinkStyle, w as IllustratedMessage, x as SvgImage, af as getBootstrapData, b as apiClient, aa as useNavigate, aO as ComboBoxForwardRef, k as SearchIcon, N as Navbar, V as Tooltip, aW as lazyLoader, u as useSettings, b6 as useAuth, b1 as Footer, aP as PageMetaTags, aD as PageStatus, e as useIsMobileMediaQuery, D as DialogTrigger, X as ButtonBase, b7 as useImageSrc, J as Form, L as FormTextField, n as showHttpErrorToast, r as ConfirmationDialog, a2 as Skeleton, d as useLocalStorage, M as Chip, q as queryClient, O as CheckIcon, b8 as FormattedCurrency, j as TextField, b9 as useDarkThemeVariables, aN as PageErrorMessage, p as useDialogContext, l as StaticPageTitle, Q as CloseIcon, G as onFormQueryError, _ as useValueLists, y as Dialog, z as DialogHeader, A as DialogBody, a7 as FileUploadProvider, Z as FormImageSelector, a4 as FormSelect, F as DialogFooter, az as isAbsoluteUrl, aX as AuthRoute, b0 as NotFoundPage } from "../server-entry.mjs";
import { b9 as useChannelQueryParams, aL as useInfiniteData, ba as channelQueryKey, bb as channelEndpoint, Y as channelContentConfig, bc as Sort, aK as SortIcon, K as KeyboardArrowRightIcon, bd as GridViewIcon, a8 as UserAvatar, be as BaseMediaLink, bf as getBaseMediaLink, u as useBackendFilterUrlParams, at as useTitleIndexFilters, A as AddFilterButton, x as TuneIcon, c as FilterListSkeleton, e as FilterList, ad as TITLE_MODEL, a3 as MOVIE_MODEL, bg as SERIES_MODEL, a$ as FormattedDateTimeRange, a5 as NewsArticleImage, a6 as NewsArticleLink, ab as BulletSeparatedItems, ag as TitlePoster, ar as TitleLink, aa as TitleRating, aI as TitleBackdrop, bh as NEWS_ARTICLE_MODEL, aX as PERSON_MODEL, aR as PersonPoster, aV as PersonLink, aD as InfiniteScrollSentinel, bi as useChannelContent, bj as PaginationControls, U as ChevronLeftIcon, aM as MediaPlayIcon, ah as getWatchLink, aW as KnownForCompact, bk as FormattedDuration, bl as InteractableRating, bm as CHANNEL_MODEL, a_ as todoImage, bn as getPersonLink, ax as getTitleLink, ay as useScrollToTop, X as useChannel, P as ImageZoomDialog, bo as ArrowForwardIcon, aF as useTitleSeasons, aG as SeasonPoster, aH as SeasonLink, bp as useCreateReview, R as Avatar, ac as StarSelector, bq as useAuthClickCapture, a9 as useDeleteReviews, M as MoreVertIcon, br as useReviews, af as ReviewListSortButton, bs as getEpisodeLink, bt as VideoGrid, aB as useSeasonEpisodes, ai as CompactSeasonEpisode, b3 as EpisodePoster, o as ChipList, g as AddIcon, au as useTitle, az as useSeason, aC as EpisodeListItem, bu as getSeasonLink, aQ as useEpisode, aj as FormattedNumber, a7 as useDeleteComments, b5 as EpisodeLink, bv as VideoGridItemSkeleton, bw as VideoGridItem, bx as EpisodeSelector, by as MediaEpisodesIcon, ap as SiteVideoPlayer, ao as VideoPlayerSkeleton, aN as VideoThumbnail, q as Accordion, r as AccordionItem, aY as usePerson, aZ as useNewsArticle, I as Tabs, J as TabList, L as Tab, b6 as TitleLinkWithEpisodeNumber, bz as StarIcon, b4 as UserProfileLink, b7 as CreateUserListPage, b8 as EditUserListPage } from "./user-profile-link-31e71b2f.mjs";
    ...
    "form",
    {
      ...
      children: /* @__PURE__ */ jsx(
        ComboBoxForwardRef,
        {
          ...
          children: (_a = data == null ? void 0 : data.results) == null ? void 0 : _a.map((result) => {
...
function WatchlistButton({
  ...
  return /* @__PURE__ */ jsx(
    Button,
    {
      variant,
      color,
      size: size === "sm" ? "xs" : void 0,
      className: clsx(size === "lg" && "mt-14 min-h-40 w-full", className2),
      ...
      children: isWatchlisted ? /* @__PURE__ */ jsx(Trans, { message: "In watchlist" }) : size === "sm" ? /* @__PURE__ */ jsx(Trans, { message: "Watchlist" }) : /* @__PURE__ */ jsx(Trans, { message: "Add to watchlist" })
    }
  );
}
function TitlePageHeader({ title, showPoster = false }) {
  return /* @__PURE__ */ jsx(
    TitlePageHeaderLayout,
    {
      ...
      right: /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between gap-10 max-md:mt-10", children: [
        /* @__PURE__ */ jsx(InteractableRating, { title }),
        /* @__PURE__ */ jsx(WatchlistButton, { item: title, size: "sm", className: "md:hidden" })
      ] })
    }
  );
}
...
function SeasonList({ title }) {
  ...
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "mb-34 flex flex-wrap items-center gap-10", children: [...new Array(title.seasons_count).keys()].map((index) => {
...
//# sourceMappingURL=site-routes-70aa5b21.mjs.map
