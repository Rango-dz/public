...
import { af as getBootstrapData, ba as useUserTimezone, m as message, c as createSvgIcon, Y as getInputFieldClassNames, ap as useField, aq as Field, e as useIsMobileMediaQuery, aU as useSelectedLocale, H as useDateFormatter, I as IconButton, K as KeyboardArrowLeftIcon, u as useSettings, am as DateFormatPresets, aT as shallowEqual, a0 as List, a1 as ListItem, T as Trans, a as useMediaQuery, aH as useAutoFocus, p as useDialogContext, F as DialogFooter, B as Button, y as Dialog, A as DialogBody, D as DialogTrigger, b as apiClient, bb as createEventHandler, bc as useIsDarkMode, a2 as Skeleton, aj as Checkbox, i as useTrans, bd as ArrowDropDownIcon, a4 as FormSelect, h as Item, be as AvatarPlaceholderIcon, V as Tooltip, S as SelectForwardRef, o as opacityAnimation, L as FormTextField, M as Chip, bf as useListbox, bg as Listbox, bh as Popover, a9 as ProgressCircle, aC as KeyboardArrowDownIcon, bi as useListboxKeyboardNavigation, z as DialogHeader, J as Form, f as useNumberFormatter, Q as CloseIcon, bj as clamp, aJ as UploadedFile, bk as rootEl, q as queryClient, t as toast, n as showHttpErrorToast, w as IllustratedMessage, x as SvgImage, aQ as WarningIcon, aO as ComboBoxForwardRef, k as SearchIcon, b7 as useImageSrc, ae as SiteConfigContext, d as useLocalStorage, ah as MenuTrigger, ai as Menu, ay as slugifyString, bl as MovieIcon, g as getFromLocalStorage, s as setInLocalStorage, b9 as useDarkThemeVariables, bm as useImageSrcSet, ac as FullPageLoader, aa as useNavigate$1, _ as useValueLists, G as onFormQueryError, b6 as useAuth, R as FormattedDate, bn as PersonIcon, l as StaticPageTitle, aD as PageStatus } from "../server-entry.mjs";
import React, { useMemo, useState, useCallback, useRef, Fragment, memo, useId, createContext, useContext, cloneElement, isValidElement, forwardRef, Children, useEffect, useLayoutEffect as useLayoutEffect$1, useImperativeHandle, Suspense } from "react";
import { useController, useFormContext, useForm } from "react-hook-form";
import clsx from "clsx";
import { E as EditIcon } from "./OpenInNew-3b47a656.mjs";
...
const Switch = React.forwardRef(
  (props, ref) => {
    ...
    const style = getSizeClassName$2(size);
...
function hasPreviousPage(pagination) {
...
var Sort = /* @__PURE__ */ ((Sort2) => {
  ...
  Sort2["attachDate"] = "channelables.created_at:desc";
  ...
  return /* @__PURE__ */ jsx(
    FormSelect,
    {
      ...
      onSelectionChange: (newValue) => {
        ...
        const firstAutoUpdateMethod = (_b2 = modelConfig.autoUpdateMethods) == null ? void 0 : _b2[0];
        setValue("config.autoUpdateMethod", firstAutoUpdateMethod);
        setValue(
          "config.autoUpdateProvider",
          firstAutoUpdateMethod ? (_c2 = config.autoUpdateMethods[firstAutoUpdateMethod]) == null ? void 0 : _c2.providers[0] : void 0
        );
...
function ContentOrderField({ config, className }) {
...
function useChannelContent(channel, params, options) {
  const [searchParams] = useSearchParams();
  const queryParams = useChannelQueryParams(channel, params);
  if (options == null ? void 0 : options.paginate) {
...
function PaginationControls({
  ...
  var _a2;
  if (!((_a2 = pagination == null ? void 0 : pagination.data) == null ? void 0 : _a2.length) || !hasNextPage(pagination) && !hasPreviousPage(pagination)) {
    return null;
  }
...
function LengthAwarePagination({
  ...
  return /* @__PURE__ */ jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsx("ul", { className: "flex items-center gap-4", children: range.map((item, index) => {
        const isCurrentPage = item === currentPage;
        return /* @__PURE__ */ jsx("li", { children: /* @__PURE__ */ jsx(
          PaginationButton,
          {
            page: !isCurrentPage ? item : void 0,
            elementType: isCurrentPage ? void 0 : Link,
            replace: true,
            variant: isCurrentPage ? "outline" : void 0,
            disabled: isCurrentPage || item === "...",
            onClick: shouldScrollToTop ? () => scrollToTop(ref) : void 0,
            children: item === "..." ? item : /* @__PURE__ */ jsx(FormattedNumber, { value: +item })
          }
        ) }, item === "..." ? `...-${index}` : item);
      }) })
    }
...
function PaginationButton({ page, ...other }) {
  const [searchParams] = useSearchParams();
  ...
  return /* @__PURE__ */ jsx(Button, { to: search2 ? { search: search2 } : void 0, ...other });
}
function SimplePagination({
  ...
  return /* @__PURE__ */ jsxs("div", { ref, className: clsx("flex items-center gap-12", className), children: [
    currentPage > 1 && /* @__PURE__ */ jsx(
      PaginationButton,
      {
        ...
        page: 1,
        replace: true,
        startIcon: /* @__PURE__ */ jsx(FirstPageIcon, {}),
        onClick: shouldScrollToTop ? () => scrollToTop(ref) : void 0,
        size: "xs",
        children: /* @__PURE__ */ jsx(Trans, { message: "First" })
      }
    ),
    /* @__PURE__ */ jsx(
      PaginationButton,
      {
        variant: "outline",
        elementType: currentPage == 1 ? void 0 : Link,
        disabled: currentPage == 1,
        className: "mr-auto min-w-110",
        page: currentPage == 1 ? void 0 : currentPage - 1,
        replace: currentPage == 1 ? void 0 : true,
    ...
    /* @__PURE__ */ jsx(
      ...
      {
        variant: "outline",
        elementType: isLastPage ? void 0 : Link,
        disabled: isLastPage,
        className: "min-w-110",
        page: isLastPage ? void 0 : currentPage + 1,
        replace: isLastPage ? void 0 : true,
...
function useReorderChannelContent() {
  return useMutation({
    mutationFn: (payload) => reorderContent(payload),
    onError: (err) => showHttpErrorToast(err)
  });
}
function reorderContent({ channelId, ids, modelType }) {
  return apiClient.post(`channel/${channelId}/reorder-content`, {
    modelType,
    ids
  }).then((r) => r.data);
}
function useAddToChannel() {
  return useMutation({
...
function removeFromChannel({ channelId, item }) {
...
const columnConfig = [
  ...
  },
  {
    ...
    body: (item) => {
      return /* @__PURE__ */ jsx(
        ...
        {
          image: item.image,
          label: item.model_type === "channel" ? /* @__PURE__ */ jsx(
            Link,
            {
  ...
  },
  {
    ...
    width: "w-42 flex-shrink-0",
    visibleInMode: "all",
    body: (item) => /* @__PURE__ */ jsx(RemoveItemColumn, { item })
  }
];
function ChannelContentEditor({
  ...
  const [perPage, setPerPage] = useState(
    ((_a2 = channel.content) == null ? void 0 : _a2.per_page) ?? 100
  );
  const contentType = watch("config.contentType");
  const addToChannel2 = useAddToChannel();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "mt-40", children: [
    ...
    !((_b2 = pagination == null ? void 0 : pagination.data) == null ? void 0 : _b2.length) ? noResultsMessage || /* @__PURE__ */ jsx(
      IllustratedMessage,
      {
        title: /* @__PURE__ */ jsx(Trans, { message: "Channel is empty" }),
        description: contentType === "manual" ? /* @__PURE__ */ jsx(Trans, { message: "No content is attached to this channel yet." }) : /* @__PURE__ */ jsx(Trans, { message: "No content to show for this channel yet." }),
...
function Pagination({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx(PaginationControls, { pagination: query.data, type: "simple" }),
        /* @__PURE__ */ jsxs(
          SelectForwardRef,
          {
            minWidth: "min-w-auto",
            ...
            labelPosition: "side",
            size: "xs",
            label: /* @__PURE__ */ jsx(Trans, { message: "Per page" }),
            selectedValue: `${perPage}`,
            onSelectionChange: (value) => onPageChange(value),
            className: "ml-auto",
            children: [
              /* @__PURE__ */ jsx(Item, { value: "50", children: "50" }),
              /* @__PURE__ */ jsx(Item, { value: "100", children: "100" }),
              /* @__PURE__ */ jsx(Item, { value: "200", children: "200" }),
              /* @__PURE__ */ jsx(Item, { value: "500", children: "500" })
            ]
          }
        )
      ]
...
function ContentTableRow({
  ...
  const domRef = useRef(null);
  const reorderContent2 = useReorderChannelContent();
  ...
  const { sortableProps } = useSortable({
    ...
    onSortEnd: (oldIndex, newIndex) => {
      ...
      if (newPagination) {
        reorderContent2.mutate({
          channelId: getValues("id"),
          modelType: item.model_type,
          ids: newPagination.data.map((item2) => item2.id)
        });
      }
    }
  });
...
function RemoveItemColumn({ item }) {
  const removeFromChannel2 = useRemoveFromChannel();
  const { getValues } = useFormContext();
  return /* @__PURE__ */ jsx(
    IconButton,
    {
      ...
      disabled: removeFromChannel2.isPending,
      onClick: () => {
        removeFromChannel2.mutate({
          channelId: getValues("id"),
          item
        });
      },
...
const HlsProvider = React.lazy(
  () => import("./hls-provider-c93ff738.mjs")
);
const DashProvider = React.lazy(
  () => import("./dash-provider-7800fa83.mjs")
);
...
const EmbedPlayer = memo(({ src, autoPlay }) => {
  ...
  if (!finalSrc) {
    return /* @__PURE__ */ jsx("div", { className: "flex aspect-video w-full items-center justify-center", children: /* @__PURE__ */ jsx("div", { className: "rounded-panel border p-10", children: /* @__PURE__ */ jsx(Trans, { message: "There was an issue playting this video." }) }) });
  }
  return /* @__PURE__ */ jsx(
    "iframe",
    {
...
function CrupdateUserListForm() {
  return /* @__PURE__ */ jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsx(ContentOrderField, { config: channelContentConfig, className: "mb-24" }),
    /* @__PURE__ */ jsxs(
      FormSelect,
      {
...
function EditUserListPage() {
  ...
  return query.data ? /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(PageContent, { list: query.data.channel, children: [
      /* @__PURE__ */ jsx(CrupdateUserListForm, {}),
      /* @__PURE__ */ jsx(
...
export {
  ...
  playlist as W,
  useChannel as X,
  channelContentConfig as Y,
  ContentModelField as Z,
  ContentOrderField as _,
  FilterControlType as a,
  FormattedDateTimeRange as a$,
  ChannelContentSearchField as a0,
  ChannelContentItemImage as a1,
  EMPTY_PAGINATION_RESPONSE as a2,
  MOVIE_MODEL as a3,
  TableContext as a4,
  NewsArticleImage as a5,
  NewsArticleLink as a6,
  useDeleteComments as a7,
  UserAvatar as a8,
  useDeleteReviews as a9,
  TvIcon as aA,
  useSeasonEpisodes as aB,
  EpisodeListItem as aC,
  InfiniteScrollSentinel as aD,
  titleSeasonsQueryKey as aE,
  useTitleSeasons as aF,
  SeasonPoster as aG,
  SeasonLink as aH,
  TitleBackdrop as aI,
  ImageIcon as aJ,
  SortIcon as aK,
  useInfiniteData as aL,
  MediaPlayIcon as aM,
  VideoThumbnail as aN,
  VideoGridItemBottomGradient as aO,
  PlayCircleIcon as aP,
  useEpisode as aQ,
  PersonPoster as aR,
  TableRow as aS,
  PRODUCTION_COUNTRY_MODEL as aT,
  GENRE_MODEL as aU,
  PersonLink as aV,
  KnownForCompact as aW,
  PERSON_MODEL as aX,
  usePerson as aY,
  useNewsArticle as aZ,
  todoImage as a_,
  TitleRating as aa,
  BulletSeparatedItems as ab,
  StarSelector as ac,
  TITLE_MODEL as ad,
  ALL_PRIMITIVE_OPERATORS as ae,
  ReviewListSortButton as af,
  TitlePoster as ag,
  getWatchLink as ah,
  CompactSeasonEpisode as ai,
  FormattedNumber as aj,
  useNormalizedModel as ak,
  FilterListItemDialogTrigger as al,
  Input as am,
  useIsTouchDevice as an,
  VideoPlayerSkeleton as ao,
  SiteVideoPlayer as ap,
  ArrowBackIcon as aq,
  TitleLink as ar,
  FormDateRangePicker as as,
  useTitleIndexFilters as at,
  useTitle as au,
  seasonQueryKey as av,
  useStickySentinel as aw,
  getTitleLink as ax,
  useScrollToTop as ay,
  useSeason as az,
  useDatatableData as b,
  useDateRangePickerState as b0,
  DateRangeComparePresets as b1,
  ...
  ArrowDownwardIcon as bA,
  ArrowRightAltIcon as bB,
  ArrowRightIcon as bC,
  FilterAltIcon as bD,
  FirstPageIcon as bE,
  NewspaperIcon as bF,
  RefreshIcon as bG,
  StarBorderIcon as bH,
  ViewListIcon as bI,
  ViewWeekIcon as bJ,
  PlayerStoreContext as bK,
  usePlayerStore as bL,
  useHtmlMediaInternalState as bM,
  useHtmlMediaEvents as bN,
  useHtmlMediaApi as bO,
  ...
  SERIES_MODEL as bg,
  NEWS_ARTICLE_MODEL as bh,
  useChannelContent as bi,
  PaginationControls as bj,
  FormattedDuration as bk,
  InteractableRating as bl,
  CHANNEL_MODEL as bm,
  getPersonLink as bn,
  ArrowForwardIcon as bo,
  useCreateReview as bp,
  useAuthClickCapture as bq,
  useReviews as br,
  getEpisodeLink as bs,
  VideoGrid as bt,
  getSeasonLink as bu,
  VideoGridItemSkeleton as bv,
  VideoGridItem as bw,
  EpisodeSelector as bx,
  MediaEpisodesIcon as by,
  StarIcon as bz,
  FilterListSkeleton as c,
  dateRangeToAbsoluteRange as d,
  FilterList as e,
  DatatableDataQueryKey as f,
  AddIcon as g,
  hasNextPage as h,
  useCurrentDateTime as i,
  useBaseDatePickerState as j,
  DatePickerField as k,
  DateRangeIcon as l,
  DateSegmentList as m,
  FormSwitch as n,
  ChipList as o,
  FormSlider as p,
  Accordion as q,
...
//# sourceMappingURL=user-profile-link-0802a161.mjs.map
