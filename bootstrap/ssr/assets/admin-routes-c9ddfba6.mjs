...
const IconList = React.lazy(() => import("./icon-list-ed5febfa.mjs"));
...
const ReportsPage = React.lazy(() => import("./admin-report-page-eac9fb74.mjs"));
...
//# sourceMappingURL=admin-routes-c9ddfba6.mjs.map
